...
export default function Home() {
  return (
    <>
      <div className="flex flex-col h-svh max-w-6xl mx-auto px-4 xl:px-0">
        <div className="flex flex-col items-start mt-18 xl:items-center space-y-4">
          <h1 className="text-5xl font-bold -tracking-[0.012em]">
          ...
          <Tabs defaultValue="code">
            <div className="flex flex-col border-2 h-fit rounded-3xl">
              ...
              <TabsContent value="code">
                <div className="flex-1 px-1 pb-1.5">
