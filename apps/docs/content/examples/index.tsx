...
export const Components: Component = {
  "hover-slash": {
    ...
    component: React.lazy(() =>
      import("@repo/ui/slash-button").then((module) => ({
        default: module.SlashButton,
      })),
    ),
  ...
  "hover-glow": {
    name: "hover-glow",
    component: React.lazy(() =>
      import("@repo/ui/glow-button").then((module) => ({
        default: module.GlowButton,
      })),
    ),
  ...
  "aesthetic-buttons": {
    ...
    component: React.lazy(() =>
      import("@repo/ui/aesthetic-button").then((module) => ({
        default: module.AestheticButton,
      })),
    ),
  ...
  "profile-card": {
    name: "profile-card",
    component: React.lazy(() =>
      import("@/components/pxui/profile-card").then((module) => ({
  ...
  "aesthetic-badges": {
    ...
    component: React.lazy(() =>
      import("@repo/ui/aesthetic-badge").then((module) => ({
        default: module.AestheticBadge,
      })),
    ),
  ...
  "gradient-chat-input": {
    ...
    component: React.lazy(() =>
      import("@repo/ui/gradient-chat-input").then((module) => ({
        default: module.GradientChatInput,
      })),
    ),
